...
import { SidenavService } from 'src/app/shared/modules/layout/sidenav/sidenav.service';
...
export class ThemeService {
  ...
  constructor(private sidenavService: SidenavService) {
    this.setTheme('template-default');
  }
  ...
  setStyle(style: 'default' | 'flat' | 'dark' | 'light' | 'top' | string) {
    switch (style) {
      case 'flat': {
        ...
        this.setTheme('template-flat');
        break;
      }

      case 'dark': {
        this.setTheme('template-dark');
        break;
      }
